                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                    <div className="max-w-xl">
                        ...
                        <motion.p
                            ...
                            className="text-slate-500 text-lg font-sans"
                        >
                    ...
                    <motion.div
                        ...
                        className="flex items-center gap-4 bg-white p-6 rounded-3xl shadow-sm border border-slate-100"
                    >
                        <div className="text-right">
                            <div className="text-3xl font-bold text-mint-dark">15+</div>
                        ...
                        <div>
                            <div className="text-3xl font-bold text-sky-dark">50k+</div>
                            <div className="text-xs uppercase tracking-widest text-slate-400 font-bold">Happy Patients</div>
                        </div>
                    </motion.div>
                </div>
