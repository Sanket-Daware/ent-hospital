                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-white border border-slate-100 rounded-[3rem] p-8 md:p-16 shadow-2xl shadow-slate-200/50">
                    ...
                    <div className="relative">
                        ...
                        <motion.div 
                            ...
                            className="hidden md:block absolute top-10 -right-8 bg-white p-5 rounded-3xl shadow-xl border border-slate-50 max-w-[180px] z-20"
                        >
                        ...
                        <motion.div 
                            ...
                            className="hidden md:block absolute -bottom-6 -left-8 bg-white p-5 rounded-3xl shadow-xl border border-slate-50 max-w-[200px] z-20"
                        >
                            <div className="flex items-center gap-3 mb-2">
