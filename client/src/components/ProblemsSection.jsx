...
const problems = [
    {
        ...
        icon: <Ear className="text-sky-dark" size={32} />,
    ...
    {
        title: 'Nasal & Sinus',
        icon: <Wind className="text-mint-dark" size={32} />,
    ...
    {
        title: 'Throat & Voice',
        icon: <MessageSquare className="text-rose-dark" size={32} />,
    ...
    {
        title: 'Head & Neck',
        icon: <ShieldAlert className="text-slate-600" size={32} />,
    ...
    {
        title: 'Pediatric ENT',
        icon: <Baby className="text-sky-dark" size={32} />,
    ...
    {
        title: 'Sleep & Snoring',
        icon: <Moon className="text-mint-dark" size={32} />,
...
const ProblemsSection = () => {
    return (
        <section className="py-24 bg-mint overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-20">
                    <motion.span
                        initial={{ opacity: 0, y: 10 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        className="text-mint-dark font-accent text-2xl mb-4 block"
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="space-y-12">
                        {problems.slice(0, 3).map((prob, i) => (
                            ...
                            >
                                <div className={`w-14 h-14 shrink-0 ${prob.color} rounded-2xl flex items-center justify-center transition-transform group-hover:scale-110`}>
                                    {prob.icon}
                                </div>
                                <div>
                                    <h3 className="text-xl font-bold text-slate-800 mb-2">{prob.title}</h3>
                                    <p className="text-slate-500 leading-relaxed font-sans text-sm">{prob.desc}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
                    ...
                    <motion.div
                        ...
                        className="relative aspect-[3/4] lg:aspect-auto lg:h-[600px] rounded-[3rem] overflow-hidden shadow-2xl shadow-slate-200/50"
                    >
                        <img
